...
namespace Report
{
    public partial class FormListKoef : Form
    {
        ...
        void FillDataGrid ()
        {
            string s = "SELECT КорректирующиеКоэффиценты.код, Наименование, ЗначениеКоэффицента.Значение FROM КорректирующиеКоэффиценты " +
                "JOIN ЗначениеКоэффицента ON ЗначениеКоэффицента.Корректирующие_ВК = КорректирующиеКоэффиценты.код " +        
                " WHERE КорректирующиеКоэффиценты.код " +
